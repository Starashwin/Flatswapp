function addToShortlist() {
		  ...
		  xhttp.open("GET", "http://localhost:8000/flatswapp/property/"+prop+"/add_shortlist", true);
...
function removeFromShortlist() {
  ...
  xhttp.open("GET", "http://localhost:8000/flatswapp/property/"+prop+"/remove_shortlist", true);
